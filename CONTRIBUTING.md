...
development setup and the project’s checks.

See also
[`CLAUDE.md`](https://trekonom.github.io/officequarto/CLAUDE.md) for the
full architecture and conventions reference (written for AI coding
agents working in this repo, but equally useful background for human
contributors).
