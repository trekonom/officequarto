...
## umgemappt (siehe R/style-mapping.R fuer die Kernlogik). Fuer
...
## R/option-aliases.R fuer die Aufloesungslogik inkl. Konfliktregel.
...
## R/style-mapping.R (oq_style_for_level()/oq_paragraph_ilvl()) und
...
## R/table-mapping.R fuer die Kernlogik; Gruppe 1 des officedown-
...
## tables_layout/tables_width (siehe R/option-aliases.R).
##
...
## R/style-pruning.R fuer die Kernlogik). Per
...
##
## Seit der Umstellung auf ein R-Paket lebt diese Logik in oq_writeback()
## (exportiert) statt in einem top-level geskripteten Hook - der Hook-Shim
## unter inst/_extensions/officequarto/scripts/writeback.R ruft nur noch
## officequarto::oq_writeback() auf. Die alte source()/get_script_dir()-
## Ladelogik entfaellt vollstaendig: R-Pakete laden alle R/*.R-Dateien
## gemeinsam in einen Namespace, Ladereihenfolge spielt keine Rolle mehr.
